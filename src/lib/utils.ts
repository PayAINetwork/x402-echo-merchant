  ...
  <script>
    ...
    function triggerConfetti() {
      if (typeof confetti !== 'undefined') {
        console.log('🎉 Triggering confetti for successful payment!');
        // Main confetti burst
        confetti({
          particleCount: 100,
          spread: 70,
        ...
        console.log('Confetti library not loaded, retrying...');
        // Retry after a short delay in case library is still loading
